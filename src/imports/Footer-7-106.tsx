import svgPaths from "./svg-0cvoqzoy48";
import imgFooter from "@/assets/618631a906a3f14879ebf268c012439e9a59550d.png";
import { imgFooter1 } from "./svg-ianwn";

export default function Footer() {
  return (
    <div className="bg-white content-stretch flex flex-col items-center px-[64px] py-[48px] relative size-full" data-name="Footer">
          ...
          <div className="content-stretch flex gap-[48px] h-[32px] items-center justify-center relative shrink-0" data-name="Social media">
            ...
            <div className="content-stretch flex gap-[4px] items-start relative shrink-0 w-[340.67px]">
              <div className="relative shrink-0 size-[24px]" data-name="mobile">
                <div className="absolute inset-[6.25%_18.75%_6.25%_22.92%] mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[-5.5px_-1.5px] mask-size-[24px_24px]" data-name="mobile" style={{ maskImage: `url('${imgFooter1}')` }}>
            ...
            <div className="content-stretch flex gap-[4px] items-start relative shrink-0 w-[340.67px]">
              <div className="relative shrink-0 size-[24px]" data-name="mail">
                <div className="absolute inset-[18.75%_10.42%] mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[-2.5px_-4.5px] mask-size-[24px_24px]" data-name="mail" style={{ maskImage: `url('${imgFooter1}')` }}>
            ...
            <div className="content-stretch flex gap-[4px] items-start relative shrink-0">
              <div className="relative shrink-0 size-[24px]" data-name="location_on">
                <div className="absolute inset-[10.42%_18.55%_10.38%_18.55%] mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[-4.452px_-2.5px] mask-size-[24px_24px]" data-name="location_on" style={{ maskImage: `url('${imgFooter1}')` }}>
