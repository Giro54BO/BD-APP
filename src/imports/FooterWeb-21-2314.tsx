import svgPaths from "./svg-qplj34tbbi";
import imgFooterWeb from "@/assets/618631a906a3f14879ebf268c012439e9a59550d.png";
import { imgFooterWeb1 } from "./svg-5sju1";

export default function FooterWeb() {
  return (
    <div className="bg-white content-stretch flex flex-col items-center px-[64px] py-[48px] relative size-full" data-name="Footer-web">
              ...
              <div className="content-stretch flex h-[44px] items-center relative shrink-0 w-[197px]" data-name="BD">
                <div className="h-[44.116px] relative shrink-0 w-[197px]" data-name="BIGDAM AZUL 1">
                  <div className="absolute inset-0 overflow-hidden pointer-events-none">
                    <img alt="" className="absolute h-[146.54%] left-[-1.54%] max-w-none top-[-23.27%] w-[102.87%]" src={imgFooterWeb} />
                  </div>
                </div>
              </div>
