  ...
  return (
    <div className="absolute content-stretch flex gap-[10px] items-center left-0 px-[64px] py-[12px] top-[128px] w-[1440px]">
      ...
      <div className="flex flex-col font-['Lato:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#302c67] text-[14px] tracking-[0.0014px] whitespace-nowrap">
        <p className="leading-[1.5]">Mi garage</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="relative shrink-0 size-[20px]" data-name="info">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="info">
          <mask height="20" id="mask0_27_8162" maskUnits="userSpaceOnUse" style={{ maskType: "alpha" }} width="20" x="0" y="0">
            <rect fill="var(--fill-0, #D9D9D9)" height="20" id="Bounding box" width="20" />
          </mask>
          <g mask="url(#mask0_27_8162)">
            <path d={svgPaths.p241ca580} fill="var(--fill-0, #1F46FD)" id="info_2" />
          </g>
        </g>
      </svg>
    </div>
...
function Contenido() {
  return (
    <div className="content-stretch flex flex-[1_0_0] gap-[6px] items-center min-h-px min-w-px relative" data-name="Contenido">
      <Info />
      <div className="flex flex-[1_0_0] flex-col font-['Lato:Regular',sans-serif] justify-center leading-[0] min-h-px min-w-px not-italic relative text-[#11278b] text-[14px] tracking-[0.0014px]">
        <p className="leading-[1.5]">Guarda tus vehículos para filtrar repuestos compatibles rápidamente.</p>
      </div>
    </div>
  );
}
...
function Frame18() {
  return (
    <div className="content-stretch flex flex-col items-start justify-center relative shrink-0 w-full">
      <p className="font-['Lato:Regular',sans-serif] leading-[1.5] not-italic relative shrink-0 text-[#302c67] text-[18px] w-full">Toyota Corolla CE, 2017</p>
    </div>
  );
}
...
function Frame27() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col h-[52px] items-start min-h-px min-w-px relative">
...
function Frame17() {
  return (
    <div className="absolute bg-[#f0f0f2] content-stretch flex gap-[24px] h-[88px] items-center left-[calc(33.33%+32px)] p-[16px] rounded-[12px] top-[392px] w-[864px]">
      <div aria-hidden="true" className="absolute border border-[#302c67] border-solid inset-0 pointer-events-none rounded-[12px]" />
      <Frame27 />
      <div className="content-stretch flex gap-[4px] h-[48px] items-center justify-center p-[16px] relative rounded-[12px] shrink-0 w-[154px]" data-name="Botones">
        <p className="font-['Lato:Regular',sans-serif] leading-[1.5] not-italic relative shrink-0 text-[#302c67] text-[16px] whitespace-nowrap">Borrar</p>
        <div className="relative shrink-0 size-[24px]" data-name="delete">
          <div className="absolute inset-[15.06%_18.75%_14.58%_18.75%] mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[-4.5px_-3.615px] mask-size-[24px_24px]" data-name="delete" style={{ maskImage: `url('${imgVerified}')` }}>
            <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 15 16.8845">
              <path d={svgPaths.p26ff8c80} fill="var(--fill-0, #302C67)" id="delete" />
            </svg>
          </div>
        </div>
      </div>
...
function Frame19() {
  return (
    <div className="content-stretch flex flex-col items-start justify-center relative shrink-0 w-full">
      <p className="font-['Lato:Regular',sans-serif] leading-[1.5] not-italic relative shrink-0 text-[#6b6b7b] text-[18px] w-full">Honda Civic, 2016</p>
    </div>
  );
}
...
function Frame28() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col h-[55px] items-start min-h-px min-w-px relative">
      <div className="relative shrink-0 size-[24px]" data-name="directions_car">
        <div className="absolute inset-[22.92%_14.58%_14.58%_14.58%] mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[-3.5px_-5.5px] mask-size-[24px_24px]" data-name="directions_car" style={{ maskImage: `url('${imgVerified}')` }}>
          <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 17 15">
            <path d={svgPaths.p69d4980} fill="var(--fill-0, #6B6B7B)" id="directions_car" />
          </svg>
        </div>
      </div>
      <Frame19 />
...
function Frame20() {
  return (
    <div className="absolute bg-[#f0f0f2] content-stretch flex gap-[24px] items-center left-[calc(33.33%+32px)] p-[16px] rounded-[12px] top-[504px] w-[864px]">
      <Frame28 />
      <div className="content-stretch flex gap-[4px] h-[48px] items-center justify-center p-[16px] relative rounded-[12px] shrink-0 w-[154px]" data-name="Botones">
        <p className="font-['Lato:Regular',sans-serif] leading-[1.5] not-italic relative shrink-0 text-[#6b6b7b] text-[16px] whitespace-nowrap">Borrar</p>
        <div className="relative shrink-0 size-[24px]" data-name="delete">
          <div className="absolute inset-[15.06%_18.75%_14.58%_18.75%] mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[-4.5px_-3.615px] mask-size-[24px_24px]" data-name="delete" style={{ maskImage: `url('${imgVerified}')` }}>
            <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 15 16.8845">
              <path d={svgPaths.p26ff8c80} fill="var(--fill-0, #6B6B7B)" id="delete" />
            </svg>
          </div>
        </div>
      </div>
...
function Frame22() {
  return (
    <div className="content-stretch flex flex-col items-start justify-center relative shrink-0 w-full">
      <p className="font-['Lato:Regular',sans-serif] leading-[1.5] not-italic relative shrink-0 text-[#6b6b7b] text-[18px] w-full">Hyundai Tucson, 2021</p>
    </div>
  );
}
...
function Frame21() {
  return (
    <div className="absolute bg-[#f0f0f2] content-stretch flex gap-[24px] items-center left-[calc(33.33%+32px)] p-[16px] rounded-[12px] top-[615px] w-[864px]">
      <Frame29 />
      <div className="content-stretch flex gap-[4px] h-[48px] items-center justify-center p-[16px] relative rounded-[12px] shrink-0 w-[154px]" data-name="Botones">
        <p className="font-['Lato:Regular',sans-serif] leading-[1.5] not-italic relative shrink-0 text-[#6b6b7b] text-[16px] whitespace-nowrap">Borrar</p>
        <div className="relative shrink-0 size-[24px]" data-name="delete">
...
function Frame24() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col items-start justify-center min-h-px min-w-px relative">
      <p className="font-['Lato:Regular',sans-serif] leading-[1.5] not-italic relative shrink-0 text-[#302c67] text-[18px] w-full">Mi garage</p>
    </div>
  );
}
    ...
    <div className="content-stretch flex gap-[4px] items-center relative shrink-0 w-full">
      <div className="relative shrink-0 size-[24px]" data-name="garage">
        <div className="absolute inset-[10.42%] mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[-2.5px_-2.5px] mask-size-[24px_24px]" data-name="garage" style={{ maskImage: `url('${imgVerified}')` }}>
          <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 19 19">
            <path d={svgPaths.p37e19700} fill="var(--fill-0, #302C67)" id="garage" />
          </svg>
        </div>
      </div>
      <Frame24 />
...
export default function MiPerfilMiPerfilMiGarage() {
  return (
    <div className="bg-white relative size-full" data-name="Mi perfil/Mi perfil/mi garage">
      <Group4 />
      <Frame16 />
      ...
      <div className="absolute bg-[#e9edff] content-stretch flex items-center left-[calc(33.33%+32px)] p-[8px] rounded-[4px] top-[329px] w-[864px]" data-name="Mensajes contextuales/BD">
        <Contenido />
      </div>
      <Frame17 />
      <Frame20 />
