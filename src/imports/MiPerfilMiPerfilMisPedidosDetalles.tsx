import svgPaths from "./svg-w2dxzt69fz";
...
import { imgVerified } from "./svg-9rvx8";
...
function Frame20() {
  return (
    <div className="absolute content-stretch flex gap-[10px] items-center left-0 px-[64px] py-[12px] top-[128px] w-[1440px]">
      ...
      <div className="flex flex-col font-['Lato:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#3375af] text-[0px] tracking-[0.0014px] whitespace-nowrap">
        <p className="leading-[1.5] text-[#6b6b7b] text-[14px]">Mis pedidos</p>
      </div>
      <div className="relative shrink-0 size-[24px]" data-name="chevron_forward">
        <div className="absolute inset-[26.44%_37.28%_26.44%_34.78%] mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[-8.347px_-6.346px] mask-size-[24px_24px]" data-name="chevron_forward" style={{ maskImage: `url('${imgVerified}')` }}>
          <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 6.7075 11.3075">
      ...
      <div className="flex flex-col font-['Lato:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#302c67] text-[14px] tracking-[0.0014px] whitespace-nowrap">
        <p className="leading-[1.5]">Detalles</p>
      </div>
    </div>
  );
}
...
function Frame24() {
  return (
    <div className="absolute bg-white content-stretch flex gap-[24px] h-[124px] items-center left-[64px] p-[12px] rounded-[12px] top-[978px] w-[864px]">
...
function Frame28() {
  return (
    <div className="content-stretch flex font-['Lato:Regular',sans-serif] items-start justify-between leading-[1.5] not-italic relative shrink-0 text-[#6b6b7b] text-[18px] w-full whitespace-nowrap">
      <p className="relative shrink-0">Subtotal (2)</p>
      <p className="relative shrink-0">$ 234.99</p>
    </div>
  );
}
...
function Frame29() {
  return (
    <div className="content-stretch flex font-['Lato:Regular',sans-serif] items-start justify-between leading-[1.5] not-italic relative shrink-0 text-[#6b6b7b] text-[18px] w-full whitespace-nowrap">
      <p className="relative shrink-0">Envió</p>
      <p className="relative shrink-0">Gratis</p>
    </div>
  );
}
...
function Frame30() {
  return (
    <div className="content-stretch flex font-['Lato:Bold',sans-serif] items-start justify-between leading-[1.3] not-italic relative shrink-0 text-[#6b6b7b] text-[24px] w-full whitespace-nowrap">
...
function Frame32() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[24px] items-start left-[66.67%] p-[24px] rounded-[12px] top-[310px] w-[416px]">
      <div aria-hidden="true" className="absolute border border-[#bfbed0] border-solid inset-0 pointer-events-none rounded-[12px]" />
      <p className="font-['Lato:Bold',sans-serif] leading-[1.3] not-italic relative shrink-0 text-[#302c67] text-[24px] w-full">Resumen</p>
      <Frame28 />
      <Frame29 />
      <div className="h-0 relative shrink-0 w-full">
        <div className="absolute inset-[-1px_0_0_0]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 368 1">
            <line id="Line 37" stroke="var(--stroke-0, #BFBED0)" x2="368" y1="0.5" y2="0.5" />
          </svg>
        </div>
      </div>
      <Frame30 />
...
function Frame21() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col items-start justify-center min-h-px min-w-px relative">
      <p className="font-['Lato:Regular',sans-serif] leading-[1.5] not-italic relative shrink-0 text-[#6b6b7b] text-[18px] w-full">Envió a domicilio</p>
    </div>
  );
}
  ...
  return (
    <div className="content-stretch flex gap-[4px] items-center relative shrink-0 w-full">
      <div className="relative shrink-0 size-[24px]" data-name="local_shipping">
        <div className="absolute inset-[18.75%_5.61%_18.51%_5.61%] mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[-1.347px_-4.5px] mask-size-[24px_24px]" data-name="local_shipping" style={{ maskImage: `url('${imgVerified}')` }}>
          <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 21.3075 15.0577">
            <path d={svgPaths.p21ffd200} fill="var(--fill-0, #6B6B7B)" id="local_shipping" />
          </svg>
        </div>
      </div>
      <Frame21 />
...
function Frame22() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col items-start justify-center min-h-px min-w-px relative">
      <p className="font-['Lato:Regular',sans-serif] leading-[1.5] not-italic relative shrink-0 text-[#6b6b7b] text-[18px] w-full">Sobre sexto anillo, a una cuadra de la Radial 17 1/2 Esquina Calle 8</p>
    </div>
  );
}
...
function Frame56() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[24px] items-start left-[66.67%] p-[24px] rounded-[12px] top-[594px] w-[416px]">
      <div aria-hidden="true" className="absolute border border-[#bfbed0] border-solid inset-0 pointer-events-none rounded-[12px]" />
      <p className="font-['Lato:Bold',sans-serif] leading-[1.3] not-italic relative shrink-0 text-[#302c67] text-[24px] w-full">Entrega</p>
      <Frame45 />
      <Frame46 />
    </div>
  );
...
function Frame23() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col items-start justify-center min-h-px min-w-px relative">
      <p className="font-['Lato:Regular',sans-serif] leading-[1.5] not-italic relative shrink-0 text-[#6b6b7b] text-[18px] w-full">Pago por QR</p>
    </div>
  );
}
...
function Frame47() {
  return (
    <div className="content-stretch flex gap-[4px] items-center relative shrink-0 w-full">
      <div className="relative shrink-0 size-[24px]" data-name="qr_code_scanner">
        <div className="absolute inset-[10.42%] mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[-2.5px_-2.5px] mask-size-[24px_24px]" data-name="qr_code_scanner" style={{ maskImage: `url('${imgVerified}')` }}>
          <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 19 19">
            <path d={svgPaths.p105de580} fill="var(--fill-0, #6B6B7B)" id="qr_code_scanner" />
          </svg>
        </div>
      </div>
      <Frame23 />
...
function Frame57() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[24px] items-start left-[66.67%] p-[24px] rounded-[12px] top-[826px] w-[416px]">
      <div aria-hidden="true" className="absolute border border-[#bfbed0] border-solid inset-0 pointer-events-none rounded-[12px]" />
      <p className="font-['Lato:Bold',sans-serif] leading-[1.3] not-italic relative shrink-0 text-[#302c67] text-[24px] w-full">Pago</p>
      <Frame47 />
    </div>
  );
}
  ...
  return (
    <div className="content-stretch flex gap-[4px] items-start relative shrink-0 w-full">
      <div className="relative shrink-0 size-[24px]" data-name="news">
        <div className="absolute inset-[14.58%] mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[-3.5px_-3.5px] mask-size-[24px_24px]" data-name="news" style={{ maskImage: `url('${imgVerified}')` }}>
          <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 17 17">
            <path d={svgPaths.p34f2edf0} fill="var(--fill-0, #6B6B7B)" id="news" />
          </svg>
        </div>
      </div>
      <div className="font-['Lato:Regular',sans-serif] leading-[0] not-italic relative shrink-0 text-[#6b6b7b] text-[18px] whitespace-nowrap">
        <p className="leading-[1.5] mb-0">Carlos Alberto Ramírez Suarez</p>
        <p className="leading-[1.5]">NIT. 8176242</p>
      </div>
    </div>
  );
}
...
function Frame58() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[24px] items-start left-[66.67%] p-[24px] rounded-[12px] top-[980px] w-[416px]">
      <div aria-hidden="true" className="absolute border border-[#bfbed0] border-solid inset-0 pointer-events-none rounded-[12px]" />
      <p className="font-['Lato:Bold',sans-serif] leading-[1.3] not-italic relative shrink-0 text-[#302c67] text-[24px] w-full">Facturación</p>
      <Frame31 />
    </div>
  );
}
...
function Frame54() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] h-[54px] items-start not-italic relative shrink-0 text-[#6b6b7b] w-[640px]">
      <p className="font-['Lato:Bold',sans-serif] leading-[1.3] relative shrink-0 text-[24px] w-full">BD-2025-00143</p>
      <p className="font-['Lato:Regular',sans-serif] leading-[1.5] relative shrink-0 text-[14px] tracking-[0.0014px] w-full">17 de abril, 2024 · 20:30 PM</p>
    </div>
  );
}
  ...
  return (
    <div className="content-stretch flex items-center relative shrink-0">
      <div className="flex flex-col font-['Lato:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#217c03] text-[12px] tracking-[0.0024px] whitespace-nowrap">
        <p className="leading-[1.4]">Entregado</p>
      </div>
    </div>
  );
}
...
function EtiquetasServiciosPequenoLight() {
  return (
    <div className="absolute bg-[#eaf7e6] content-center flex flex-wrap gap-y-[4px] items-center justify-center left-[525px] px-[12px] py-[4px] rounded-[999px] top-[14px]" data-name="Etiquetas servicios/PequeñoLight">
      <Frame33 />
    </div>
  );
}
...
function Frame55() {
  return (
    <div className="absolute content-stretch flex items-start justify-between left-[68px] top-[322px] w-[860px]">
      <Frame54 />
      <div className="bg-white content-stretch flex gap-[4px] h-[54px] items-center justify-center p-[16px] relative rounded-[12px] shrink-0" data-name="Botones">
        <p className="font-['Lato:Regular',sans-serif] leading-[1.5] not-italic relative shrink-0 text-[#302c67] text-[16px] whitespace-nowrap">Reordenar pedido</p>
...
function Frame35() {
  return (
    <div className="bg-white content-stretch flex items-center justify-center p-[10px] relative rounded-[999px] shrink-0 size-[24px]">
      <div className="relative shrink-0 size-[24px]" data-name="Boton radio">
        <div className="absolute inset-[10.42%] mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[-2.5px_-2.5px] mask-size-[24px_24px]" data-name="check_circle" style={{ maskImage: `url('${imgVerified}')` }}>
          <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 19 19">
            <path d={svgPaths.p2af23f80} fill="var(--fill-0, #302C67)" id="check_circle" />
          </svg>
        </div>
      </div>
    </div>
...
function Frame60() {
  return (
    <div className="content-stretch flex flex-col font-['Lato:Regular',sans-serif] items-start leading-[0] not-italic relative shrink-0">
      <div className="flex flex-col justify-center relative shrink-0 text-[#302c67] text-[16px] w-[123px]">
        <p className="leading-[1.5]">Pedido recibido</p>
      </div>
      <div className="flex flex-col justify-center relative shrink-0 text-[#6b6b7b] text-[14px] tracking-[0.0014px] w-[123px]">
        <p className="leading-[1.5]">10 de marzo, 16:00</p>
      </div>
    </div>
  );
}
...
function Frame62() {
  return (
    <div className="content-stretch flex flex-col font-['Lato:Regular',sans-serif] items-start leading-[0] not-italic relative shrink-0">
      <div className="flex flex-col justify-center relative shrink-0 text-[#302c67] text-[16px] w-[123px]">
        <p className="leading-[1.5]">Pago confirmado</p>
      </div>
      <div className="flex flex-col justify-center relative shrink-0 text-[#6b6b7b] text-[14px] tracking-[0.0014px] w-[123px]">
        <p className="leading-[1.5]">10 de marzo, 16:15</p>
      </div>
    </div>
  );
}
...
function Frame63() {
  return (
    <div className="content-stretch flex flex-col font-['Lato:Regular',sans-serif] items-start leading-[0] not-italic relative shrink-0">
      <div className="flex flex-col justify-center relative shrink-0 text-[#302c67] text-[16px] w-[123px]">
        <p className="leading-[1.5]">En preparación</p>
      </div>
      <div className="flex flex-col justify-center relative shrink-0 text-[#6b6b7b] text-[14px] tracking-[0.0014px] w-[123px]">
        <p className="leading-[1.5]">10 de marzo, 16:30</p>
      </div>
    </div>
  );
}
...
function Frame64() {
  return (
    <div className="content-stretch flex flex-col font-['Lato:Regular',sans-serif] items-start leading-[0] not-italic relative shrink-0">
      <div className="flex flex-col justify-center relative shrink-0 text-[#302c67] text-[16px] w-[123px]">
        <p className="leading-[1.5]">Enviado</p>
      </div>
      <div className="flex flex-col justify-center relative shrink-0 text-[#6b6b7b] text-[14px] tracking-[0.0014px] w-[123px]">
        <p className="leading-[1.5]">11 de marzo, 9:00</p>
      </div>
    </div>
  );
}
...
function Frame65() {
  return (
    <div className="content-stretch flex flex-col font-['Lato:Regular',sans-serif] items-start leading-[0] not-italic relative shrink-0">
      <div className="flex flex-col justify-center relative shrink-0 text-[#302c67] text-[16px] w-[123px]">
        <p className="leading-[1.5]">Entregado</p>
      </div>
      <div className="flex flex-col justify-center relative shrink-0 text-[#6b6b7b] text-[14px] tracking-[0.0014px] w-[123px]">
        <p className="leading-[1.5]">11 de marzo, 16:00</p>
      </div>
    </div>
  );
}
...
function Frame61() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-start relative shrink-0">
      <div className="absolute flex h-[244px] items-center justify-center left-[11px] top-[12px] w-0" style={{ "--transform-inner-width": "1200", "--transform-inner-height": "19" } as React.CSSProperties}>
        <div className="flex-none rotate-90">
          <div className="h-0 relative w-[244px]">
            <div className="absolute inset-[-1px_0_0_0]">
              <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 244 1">
                <line id="Line 45" stroke="var(--stroke-0, #302C67)" x2="244" y1="0.5" y2="0.5" />
              </svg>
            </div>
          </div>
        </div>
...
function Frame59() {
  return (
    <div className="-translate-x-1/2 absolute content-stretch flex flex-col gap-[24px] items-start justify-center left-[calc(33.33%+16px)] p-[48px] rounded-[12px] top-[408px] w-[864px]">
      <div aria-hidden="true" className="absolute border border-[#bfbed0] border-solid inset-0 pointer-events-none rounded-[12px]" />
      <p className="font-['Lato:Bold',sans-serif] leading-[1.25] not-italic relative shrink-0 text-[#6b6b7b] text-[32px] tracking-[-0.0016px] w-[640px]">Seguimiento</p>
      <Frame61 />
    </div>
  );
}
...
export default function MiPerfilMiPerfilMisPedidosDetalles() {
  return (
    <div className="bg-white relative size-full" data-name="Mi perfil/Mi perfil/Mis pedidos/detalles">
      <Group4 />
      <Frame20 />
      <p className="absolute font-['DM_Sans:Bold',sans-serif] font-bold leading-[1.15] left-[68px] text-[#6b6b7b] text-[56px] top-[208px] tracking-[-0.0084px] w-[640px]" style={{ fontVariationSettings: "'opsz' 14" }}>
        Mis pedidos
      </p>
      <p className="absolute font-['Lato:Bold',sans-serif] leading-[1.25] left-[68px] not-italic text-[#6b6b7b] text-[32px] top-[999px] tracking-[-0.0016px] w-[640px]">{` `}</p>
      ...
      <div className="-translate-x-1/2 absolute h-0 left-[calc(33.33%+16px)] top-[947px] w-[864px]">
        <div className="absolute inset-[-1px_0_0_0]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 864 1">
            <line id="Line 36" stroke="var(--stroke-0, #BFBED0)" x2="864" y1="0.5" y2="0.5" />
          </svg>
        </div>
      </div>
      <Frame24 />
      ...
      <Frame55 />
      <Frame59 />
      <p className="absolute font-['Lato:Bold',sans-serif] leading-[1.25] left-[64px] not-italic text-[#6b6b7b] text-[32px] top-[891px] tracking-[-0.0016px] w-[640px]">Productos</p>
      <div className="absolute bottom-0 h-[1791px] left-0 pointer-events-none top-[48px]">
