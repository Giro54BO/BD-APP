import svgPaths from "./svg-z3h66sdv4u";
import imgFooterWeb from "@/assets/618631a906a3f14879ebf268c012439e9a59550d.png";
import { imgFooterWeb1 } from "./svg-pcvhc";

export default function FooterWeb() {
  return (
    <div className="bg-white content-stretch flex flex-col gap-[48px] items-start p-[32px] relative size-full" data-name="Footer-web">
      <div aria-hidden="true" className="absolute border-[#bfbed0] border-solid border-t-[0.528px] inset-0 pointer-events-none" />
      <div className="h-[149px] relative shrink-0 w-[330px]" data-name="Container">
        <div className="absolute h-[63.995px] left-0 top-0 w-[200.609px]" data-name="Image (BigDam Logo)">
          <img alt="" className="absolute inset-0 max-w-none object-contain pointer-events-none size-full" src={imgFooterWeb} />
        </div>
        <div className="absolute h-[68.233px] left-0 top-[64px] w-[199.999px]" data-name="Paragraph">
          <p className="absolute font-['Lato:Regular',sans-serif] leading-[22.75px] left-0 not-italic text-[#6b6b7b] text-[14px] top-[-0.36px] w-[167px]">© 2025 BigDam Repuestos Automotrices. Todos los derechos reservados</p>
        </div>
      </div>
      <div className="content-stretch flex flex-col gap-[19.999px] h-[207.979px] items-start relative shrink-0 w-full" data-name="Container">
        <p className="font-['Lato:Bold',sans-serif] leading-[32px] not-italic relative shrink-0 text-[#6b6b7b] text-[24px] whitespace-nowrap">Categorías</p>
        <div className="h-[155.986px] relative shrink-0 w-[329.598px]" data-name="Navigation">
          <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col font-['Lato:Regular',sans-serif] gap-[19.999px] items-start leading-[24px] not-italic relative size-full text-[#6b6b7b] text-[16px] whitespace-nowrap">
            <p className="relative shrink-0">Autopartes</p>
            <p className="relative shrink-0">Electrónica</p>
            <p className="relative shrink-0">Ferretería</p>
            <p className="relative shrink-0">Ver más</p>
          </div>
        </div>
      </div>
      <div className="content-stretch flex flex-col gap-[19.999px] items-start relative shrink-0 w-full" data-name="Container">
        <p className="font-['Lato:Bold',sans-serif] leading-[32px] not-italic relative shrink-0 text-[#6b6b7b] text-[24px] whitespace-nowrap">Quienes somos</p>
        <div className="relative shrink-0 w-[329.598px]" data-name="Navigation">
          <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col font-['Lato:Regular',sans-serif] gap-[19.999px] items-start leading-[24px] not-italic relative text-[#6b6b7b] text-[16px] w-full whitespace-nowrap">
      ...
      <div className="content-stretch flex flex-col gap-[19.999px] items-start relative shrink-0 w-full" data-name="Container">
        <p className="font-['Lato:Bold',sans-serif] leading-[32px] not-italic relative shrink-0 text-[#6b6b7b] text-[24px] whitespace-nowrap">Ayuda</p>
        <div className="relative shrink-0 w-[329.598px]" data-name="Navigation">
          <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start relative w-full">
            <p className="font-['Lato:Regular',sans-serif] leading-[24px] not-italic relative shrink-0 text-[#6b6b7b] text-[16px] whitespace-nowrap">Centro de ayuda</p>
          </div>
        </div>
      </div>
      ...
      <div className="h-[0.528px] opacity-50 relative shrink-0 w-full" data-name="Container">
        <div aria-hidden="true" className="absolute border-[#bfbed0] border-solid border-t-[0.528px] inset-0 pointer-events-none" />
      </div>
      <div className="content-stretch flex flex-col gap-[48px] items-start relative shrink-0" data-name="Social media">
        ...
        <div className="content-stretch flex gap-[4px] items-start relative shrink-0 w-[340.67px]">
          <div className="relative shrink-0 size-[24px]" data-name="mobile">
            <div className="absolute inset-[6.25%_18.75%_6.25%_22.92%] mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[-5.5px_-1.5px] mask-size-[24px_24px]" data-name="mobile" style={{ maskImage: `url('${imgFooterWeb1}')` }}>
        ...
        <div className="content-stretch flex gap-[4px] items-start relative shrink-0 w-[340.67px]">
          <div className="relative shrink-0 size-[24px]" data-name="mail">
            <div className="absolute inset-[18.75%_10.42%] mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[-2.5px_-4.5px] mask-size-[24px_24px]" data-name="mail" style={{ maskImage: `url('${imgFooterWeb1}')` }}>
        ...
        <div className="content-stretch flex gap-[4px] items-start relative shrink-0">
          <div className="relative shrink-0 size-[24px]" data-name="location_on">
            <div className="absolute inset-[10.42%_18.55%_10.38%_18.55%] mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[-4.452px_-2.5px] mask-size-[24px_24px]" data-name="location_on" style={{ maskImage: `url('${imgFooterWeb1}')` }}>
