import svgPaths from "./svg-dj7jdsunkh";
...
import { imgVerified, imgKidStar } from "./svg-qlijb";
...
function Frame96() {
  return (
    <div className="absolute content-stretch flex items-center justify-between left-[68px] top-[848px] w-[1305px]">
      <p className="font-['Lato:Bold',sans-serif] leading-[1.3] not-italic relative shrink-0 text-[#6b6b7b] text-[24px] w-[142px]">Filtros</p>
    ...
    <div className="bg-white h-[52px] relative rounded-[12px] shrink-0 w-full" data-name="Campo">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[12px] items-center px-[12px] py-[4px] relative size-full">
          ...
          <p className="flex-[1_0_0] font-['Lato:Regular',sans-serif] leading-[1.5] min-h-px min-w-px not-italic relative text-[#6b6b7b] text-[14px] tracking-[0.0014px]">Buscar por código código OEM, número de chasis , o N° VIN</p>
...
function Frame98() {
  return (
    <div className="content-stretch flex items-end justify-between relative shrink-0 w-full">
      ...
      <div className="bg-[#f0f0f2] content-stretch flex gap-[4px] h-[54px] items-center justify-center p-[16px] relative rounded-[12px] shrink-0 w-[400px]" data-name="Botones">
        <p className="font-['Lato:Regular',sans-serif] leading-[1.5] not-italic relative shrink-0 text-[#6b6b7b] text-[16px] whitespace-nowrap">Buscar</p>
        <div className="relative shrink-0 size-[24px]" data-name="search">
          <div className="absolute inset-[14.1%_14.18%_14.26%_14.18%] mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[-3.404px_-3.385px] mask-size-[24px_24px]" data-name="search" style={{ maskImage: `url('${imgVerified}')` }}>
            <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 17.192 17.1923">
...
export default function DetalleDeProductoCodigo() {
  return (
    <div className="bg-white relative size-full" data-name="Detalle de producto/codigo">
      <Group1 />
