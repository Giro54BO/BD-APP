import svgPaths from "./svg-vsn6mwfnay";
import imgBigdamAzul1 from "@/assets/618631a906a3f14879ebf268c012439e9a59550d.png";
import imgImage from "@/assets/398e16289a86bfed3d8f9ed15839148300506518.png";
import imgImage1 from "@/assets/69650ec95c8057bbdf3f3adf4d0ad99c92bcb59a.png";
import imgImage2 from "@/assets/a2b639c78c14f1187c3d1a76d3337b22cbcb4079.png";
import { imgVerified } from "./svg-kbtun";
...
function Frame9() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[4px] items-start left-[64px] text-white top-[174px] w-[1312px]">
      <p className="font-['DM_Sans:Bold',sans-serif] font-bold h-[74px] leading-[1.1] relative shrink-0 text-[64px] tracking-[-0.0128px] w-full" style={{ fontVariationSettings: "'opsz' 14" }}>
        Blog
      </p>
      <p className="font-['Lato:Regular',sans-serif] leading-[1.3] not-italic relative shrink-0 text-[24px] w-full">Guías, consejos y novedades para elegir mejor tus productos y aprovechar al máximo tus compras</p>
    </div>
  );
}
...
function Frame1() {
  return (
    <div className="content-stretch flex flex-col gap-[12px] items-start relative shrink-0 w-full">
      <div className="flex flex-col font-['Lato:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#3e5061] text-[16px] w-full">
        <p className="leading-[1.5] whitespace-pre-wrap">{`Aprende a identificar  cuando  es el momento ideal para cambiar el aceite de tu vehículo y  evitar daños en el motor.`}</p>
      </div>
      <div className="bg-[#302c67] h-[54px] relative rounded-[12px] shrink-0 w-full" data-name="Botones">
        <div className="flex flex-row items-center justify-center size-full">
          <div className="content-stretch flex gap-[4px] items-center justify-center p-[16px] relative size-full">
            <p className="font-['Lato:Regular',sans-serif] leading-[1.5] not-italic relative shrink-0 text-[16px] text-white whitespace-nowrap">Leer ahora</p>
...
function Frame() {
  return (
    <div className="bg-white content-stretch flex flex-col gap-[24px] items-start p-[24px] relative rounded-[12px] shrink-0 w-[418px]">
      <div aria-hidden="true" className="absolute border-[#bfbed0] border-[1.197px] border-solid inset-0 pointer-events-none rounded-[12px]" />
      <div className="h-[271.721px] relative rounded-[4px] shrink-0 w-full" data-name="image">
        <div className="absolute inset-0 overflow-hidden pointer-events-none rounded-[4px]">
          <img alt="" className="absolute h-[178.3%] left-[-25.5%] max-w-none top-[-35.5%] w-[196.41%]" src={imgImage} />
        </div>
      </div>
      <p className="font-['Lato:Bold',sans-serif] leading-[1.3] not-italic relative shrink-0 text-[#3e5061] text-[24px] w-full whitespace-pre-wrap">{`¿Cada cuanto cambiar el  aceite de tu vehículo?`}</p>
      <Frame1 />
    </div>
  );
}
...
function Frame10() {
  return (
    <div className="bg-white content-stretch flex flex-col gap-[24px] items-start p-[24px] relative rounded-[12px] shrink-0 w-[418px]">
      ...
      <p className="font-['Lato:Bold',sans-serif] leading-[1.3] not-italic relative shrink-0 text-[#3e5061] text-[24px] w-full">10 consejos para mantener tus herramientas como nuevas</p>
      <Frame2 />
    </div>
  );
}
...
function Frame11() {
  return (
    <div className="bg-white content-stretch flex flex-col gap-[24px] items-start p-[24px] relative rounded-[12px] shrink-0 w-[418px]">
      <div aria-hidden="true" className="absolute border-[#bfbed0] border-[1.197px] border-solid inset-0 pointer-events-none rounded-[12px]" />
      <div className="h-[271.721px] relative rounded-[4px] shrink-0 w-full" data-name="image">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none rounded-[4px] size-full" src={imgImage2} />
      </div>
      <p className="font-['Lato:Bold',sans-serif] leading-[1.3] not-italic relative shrink-0 text-[#3e5061] text-[24px] w-full">7 trucos para ahorrar la batería de tu smartphone</p>
      <Frame3 />
    </div>
  );
}
...
function Frame27() {
  return (
    <div className="absolute content-stretch flex items-center justify-between left-[64px] top-[489px] w-[1312px]">
      <Frame />
      <Frame10 />
      <Frame11 />
    </div>
...
function Frame24() {
  return (
    <div className="absolute content-stretch flex items-center justify-between left-[68px] top-[399px] w-[1305px]">
      <p className="font-['Lato:Bold',sans-serif] leading-[1.3] not-italic relative shrink-0 text-[#6b6b7b] text-[24px] w-[802px]">Filtros</p>
      <div className="content-stretch flex gap-[4px] h-[52px] items-center justify-center p-[16px] relative rounded-[12px] shrink-0 w-[192px]" data-name="Botones">
        <div aria-hidden="true" className="absolute border border-[#302c67] border-solid inset-0 pointer-events-none rounded-[12px]" />
        <p className="font-['Lato:Regular',sans-serif] leading-[1.5] not-italic relative shrink-0 text-[#302c67] text-[16px] whitespace-nowrap">Recientes</p>
        <div className="relative shrink-0 size-[24px]" data-name="arrow_forward">
          <div className="absolute inset-[18.75%] mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[-4.5px_-4.5px] mask-size-[24px_24px]" data-name="arrow_forward" style={{ maskImage: `url('${imgVerified}')` }}>
            <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 15 15">
...
function Frame23() {
  return (
    <div className="absolute content-stretch flex gap-[10px] items-center left-0 px-[64px] py-[12px] top-[328px] w-[1440px]">
...
export default function Blog() {
  return (
    <div className="bg-white relative size-full" data-name="Blog">
      <Group4 />
      <div className="absolute bottom-0 h-[1702px] left-0 pointer-events-none top-[48px]">
      ...
      <div className="absolute bg-[#262352] h-[200px] left-0 top-[128px] w-[1440px]" />
      <Frame9 />
      <Frame27 />
      <Frame24 />
      <Frame23 />
