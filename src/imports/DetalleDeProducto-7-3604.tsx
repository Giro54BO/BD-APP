import svgPaths from "./svg-7r8u8d4ra9";
import imgRectangle101 from "@/assets/f457811434c66cda25bd3fff19e6630ab0412ab8.png";
import imgRectangle102 from "@/assets/47838e3498b77899012df132f49ad3759bcd7cff.png";
...
import { imgVerified, imgKidStar } from "./svg-75y1x";
...
function Frame89() {
  return (
    <div className="absolute gap-x-[32px] gap-y-[32px] grid-cols-[repeat(3,fit-content(100%))] grid-rows-[____fit-content(100%)_fit-content(100%)_fit-content(100%)_542.00px] inline-grid left-[calc(25%+41px)] top-[933px]">
      <Frame22 />
      <Frame83 />
      <Frame80 />
      <Frame82 />
...
function Frame98() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[16px] items-start left-[64px] top-[933px]">
...
function Frame116() {
  return (
    <div className="absolute content-stretch flex items-center justify-between left-[64px] top-[831px] w-[1312px]">
      <p className="font-['Lato:Bold',sans-serif] leading-[1.3] not-italic relative shrink-0 text-[#6b6b7b] text-[24px] w-[137px]">Filtros</p>
    ...
    <div className="h-[48px] relative shrink-0 w-full">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center p-[12px] relative size-full">
          <p className="font-['Lato:Regular',sans-serif] leading-[1.5] not-italic relative shrink-0 text-[#6b6b7b] text-[14px] tracking-[0.0014px] whitespace-nowrap">Relevancia</p>
        </div>
      </div>
    </div>
  );
...
function Frame11() {
  return (
    <div className="h-[48px] relative shrink-0 w-full">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center p-[12px] relative size-full">
          <p className="font-['Lato:Regular',sans-serif] leading-[1.5] not-italic relative shrink-0 text-[#6b6b7b] text-[14px] tracking-[0.0014px] whitespace-nowrap">Descuentos</p>
        </div>
      </div>
    </div>
  );
...
function Frame12() {
  return (
    <div className="h-[48px] relative shrink-0 w-full">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center p-[12px] relative size-full">
          <p className="font-['Lato:Regular',sans-serif] leading-[1.5] not-italic relative shrink-0 text-[#6b6b7b] text-[14px] tracking-[0.0014px] whitespace-nowrap">Más recientes</p>
        </div>
      </div>
    </div>
  );
...
function Frame13() {
  return (
    <div className="h-[48px] relative shrink-0 w-full">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center p-[12px] relative size-full">
          <p className="font-['Lato:Regular',sans-serif] leading-[1.5] not-italic relative shrink-0 text-[#6b6b7b] text-[14px] tracking-[0.0014px] whitespace-nowrap">Alfabéticamente, A-Z</p>
        </div>
      </div>
    </div>
  );
...
function Frame14() {
  return (
    <div className="h-[48px] relative shrink-0 w-full">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center p-[12px] relative size-full">
          <p className="font-['Lato:Regular',sans-serif] leading-[1.5] not-italic relative shrink-0 text-[#6b6b7b] text-[14px] tracking-[0.0014px] whitespace-nowrap">Alfabéticamente, Z-A</p>
        </div>
      </div>
    </div>
  );
...
function TipoDeCliente() {
  return (
    <div className="absolute bg-white content-stretch flex flex-col items-start left-[calc(66.67%-11px)] rounded-[12px] top-[882px] w-[192px]" data-name="Tipo de cliente">
...
function EtiquetasServiciosPequenoLight5() {
  return (
    <div className="absolute bg-[#e30613] content-center flex flex-wrap gap-y-[4px] items-center justify-center left-[24px] px-[12px] py-[4px] rounded-[50px] top-[24px]" data-name="Etiquetas servicios/PequeñoLight">
      <div className="flex flex-col font-['Lato:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[18px] text-white whitespace-nowrap">
        <p className="leading-[1.5]">-23%</p>
...
function Frame63() {
  return (
    <div className="bg-white content-stretch flex flex-col gap-[24px] h-[679px] items-center p-[24px] relative rounded-[12px] shrink-0 w-[416px]">
      ...
      <Frame64 />
      <EtiquetasServiciosPequenoLight5 />
    </div>
  );
}
...
function Frame118() {
  return (
    <div className="-translate-x-1/2 absolute content-stretch flex flex-col gap-[24px] items-start left-[calc(50%+0.5px)] top-[2851px] w-[1319px]">
      <p className="font-['Lato:Bold',sans-serif] leading-[1.25] not-italic relative shrink-0 text-[#302c67] text-[32px] tracking-[-0.0016px] w-full">Más populares</p>
      <Frame119 />
    </div>
  );
}
...
function Campo2() {
  return (
    <div className="h-[52px] relative rounded-[12px] shrink-0 w-full" data-name="Campo">
      <div aria-hidden="true" className="absolute border border-[#302c67] border-solid inset-0 pointer-events-none rounded-[12px]" />
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[12px] items-center px-[12px] py-[4px] relative size-full">
          ...
          <p className="flex-[1_0_0] font-['Lato:Regular',sans-serif] leading-[1.5] min-h-px min-w-px not-italic relative text-[#6b6b7b] text-[14px] tracking-[0.0014px]">Seleccionar o buscar marca</p>
          <div className="relative shrink-0 size-[24px]" data-name="keyboard_arrow_down">
            <div className="absolute inset-[34.78%_26.44%_37.28%_26.44%] mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[-6.347px_-8.346px] mask-size-[24px_24px]" data-name="keyboard_arrow_down" style={{ maskImage: `url('${imgVerified}')` }}>
              <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 11.3075 6.7075">
                <path d={svgPaths.p34b30800} fill="var(--fill-0, #302C67)" id="keyboard_arrow_down" />
    ...
    <div className="bg-white h-[52px] relative rounded-[12px] shrink-0 w-full" data-name="Campo">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[12px] items-center px-[12px] py-[4px] relative size-full">
          ...
          <p className="flex-[1_0_0] font-['Lato:Regular',sans-serif] leading-[1.5] min-h-px min-w-px not-italic relative text-[#6b6b7b] text-[14px] tracking-[0.0014px]">Seleccionar modelo</p>
          <div className="relative shrink-0 size-[24px]" data-name="keyboard_arrow_down">
            <div className="absolute inset-[34.78%_26.44%_37.28%_26.44%] mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[-6.347px_-8.346px] mask-size-[24px_24px]" data-name="keyboard_arrow_down" style={{ maskImage: `url('${imgVerified}')` }}>
              <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 11.3075 6.7075">
                <path d={svgPaths.p34b30800} fill="var(--fill-0, #302C67)" id="keyboard_arrow_down" />
...
function Campo4() {
  return (
    <div className="bg-white h-[52px] relative rounded-[12px] shrink-0 w-full" data-name="Campo">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[12px] items-center px-[12px] py-[4px] relative size-full">
          <p className="flex-[1_0_0] font-['Lato:Regular',sans-serif] leading-[1.5] min-h-px min-w-px not-italic relative text-[#6b6b7b] text-[14px] tracking-[0.0014px]">Seleccionar año</p>
          <div className="relative shrink-0 size-[24px]" data-name="keyboard_arrow_down">
            <div className="absolute inset-[34.78%_26.44%_37.28%_26.44%] mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[-6.347px_-8.346px] mask-size-[24px_24px]" data-name="keyboard_arrow_down" style={{ maskImage: `url('${imgVerified}')` }}>
              <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 11.3075 6.7075">
...
function Frame121() {
  return (
    <div className="content-stretch flex items-start justify-between relative shrink-0 w-full">
      <div className="bg-[#f0f0f2] content-stretch flex gap-[4px] h-[54px] items-center justify-center p-[16px] relative rounded-[12px] shrink-0 w-[772px]" data-name="Botones">
        <p className="font-['Lato:Regular',sans-serif] leading-[1.5] not-italic relative shrink-0 text-[#6b6b7b] text-[16px] whitespace-nowrap">Buscar repuestos compatibles</p>
        <div className="relative shrink-0 size-[24px]" data-name="search">
          <div className="absolute inset-[14.1%_14.18%_14.26%_14.18%] mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[-3.404px_-3.385px] mask-size-[24px_24px]" data-name="search" style={{ maskImage: `url('${imgVerified}')` }}>
            <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 17.192 17.1923">
              <path d={svgPaths.p34e8e200} fill="var(--fill-0, #6B6B7B)" id="search" />
            </svg>
          </div>
        </div>
      </div>
...
function Frame120() {
  return (
    <div className="-translate-x-1/2 absolute bg-white content-stretch flex flex-col gap-[24px] items-start left-1/2 px-[64px] py-[48px] rounded-[24px] top-[407px] w-[1312px]">
      <div aria-hidden="true" className="absolute border-[#bfbed0] border-[0.5px] border-solid inset-0 pointer-events-none rounded-[24px]" />
      <Frame9 />
      <div className="h-0 relative shrink-0 w-full">
        <div className="absolute inset-[-1px_0_0_0]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 1184 1">
            <line id="Line 30" stroke="var(--stroke-0, #F0F0F2)" x2="1184" y1="0.5" y2="0.5" />
          </svg>
        </div>
      </div>
      <Frame8 />
      <Frame121 />
      <div className="absolute h-0 left-[64px] top-[103px] w-[238px]">
...
export default function DetalleDeProducto() {
  return (
    <div className="bg-white relative size-full" data-name="Detalle de producto">
      ...
      <TipoDeCliente />
      <Frame118 />
      <div className="absolute bottom-0 h-[4232px] left-0 pointer-events-none top-[48px]">
      ...
      <div className="-translate-x-1/2 absolute bg-white bottom-[81px] content-stretch flex flex-col items-center left-1/2 px-[64px] py-[48px] w-[1440px]" data-name="Footer">
        <div aria-hidden="true" className="absolute border-[#bfbed0] border-solid border-t inset-0 pointer-events-none" />
        <Frame77 />
      </div>
      <div className="absolute h-[60px] left-[calc(91.67%+1px)] top-[2677px] w-[65px]">
        <Group3 />
