...
function Campo() {
  return (
    <div className="content-stretch flex items-center py-[4px] relative rounded-[12px] shrink-0 w-full" data-name="Campo">
      <p className="font-['Lato:Regular',sans-serif] leading-[1.5] not-italic relative shrink-0 text-[#6b6b7b] text-[14px] tracking-[0.0014px] whitespace-nowrap">{`Carlos Alberto Ramírez Suarez `}</p>
    </div>
  );
}
...
function Campo1() {
  return (
    <div className="content-stretch flex items-center py-[4px] relative rounded-[12px] shrink-0 w-full" data-name="Campo">
      <p className="font-['Lato:Regular',sans-serif] leading-[1.5] not-italic relative shrink-0 text-[#6b6b7b] text-[14px] tracking-[0.0014px] whitespace-nowrap">carlosalberto@correo.com</p>
    </div>
  );
}
...
function Campo2() {
  return (
    <div className="content-stretch flex items-center py-[4px] relative rounded-[12px] shrink-0 w-full" data-name="Campo">
      <p className="font-['Lato:Regular',sans-serif] leading-[1.5] not-italic relative shrink-0 text-[#6b6b7b] text-[14px] tracking-[0.0014px] whitespace-nowrap">{`(+ 591) 763 02502 `}</p>
    </div>
  );
}
...
function Campos2() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-start relative shrink-0 w-[384px]" data-name="Campos">
      <p className="font-['Lato:Regular',sans-serif] h-[24px] leading-[1.5] not-italic relative shrink-0 text-[#302c67] text-[14px] tracking-[0.0014px] w-full">Número de telefóno</p>
      <Campo2 />
    </div>
  );
}
...
function Campo3() {
  return (
    <div className="content-stretch flex items-center py-[4px] relative rounded-[12px] shrink-0 w-full" data-name="Campo">
      <p className="font-['Lato:Regular',sans-serif] leading-[1.5] not-italic relative shrink-0 text-[#6b6b7b] text-[14px] tracking-[0.0014px] whitespace-nowrap">8176454</p>
    </div>
  );
}
...
function Campos3() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-start relative shrink-0 w-[384px]" data-name="Campos">
      <p className="font-['Lato:Regular',sans-serif] h-[24px] leading-[1.5] not-italic relative shrink-0 text-[#302c67] text-[14px] tracking-[0.0014px] w-full">Cédula de identidad (C.I.)</p>
      <Campo3 />
    </div>
  );
}
...
function Frame25() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[24px] items-end left-[calc(33.33%+32px)] p-[24px] rounded-[12px] top-[329px] w-[864px]">
      ...
      <div className="flex flex-col font-['Lato:Bold',sans-serif] h-[58px] justify-center leading-[0] not-italic relative shrink-0 text-[#302c67] text-[24px] w-full">
        <p className="leading-[1.3]">Hola, Carlos</p>
      </div>
      <Frame26 />
      <Frame27 />
      <div className="flex flex-col font-['Lato:Bold',sans-serif] h-[58px] justify-center leading-[0] not-italic relative shrink-0 text-[#302c67] text-[24px] w-full">
...
export default function MiPerfilMiPerfilEditar() {
  return (
    <div className="bg-white relative size-full" data-name="Mi perfil/Mi perfil/editar">
      <Group4 />
      <Frame16 />
      ...
      <Frame25 />
      <Frame39 />
      <div className="absolute bg-[#302c67] content-stretch flex gap-[4px] h-[52px] items-center justify-center left-[calc(33.33%+32px)] p-[16px] rounded-[12px] top-[796px] w-[193px]" data-name="Botones">
        <p className="font-['Lato:Regular',sans-serif] leading-[1.5] not-italic relative shrink-0 text-[16px] text-white whitespace-nowrap">Editar perfil</p>
