import svgPaths from "./svg-byon5s4yjb";
...
import { imgVerified } from "./svg-q7eq0";
...
function Frame5() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[24px] items-start left-[125px] text-white top-[298px] w-[528px]">
      <p className="font-['DM_Sans:Bold',sans-serif] font-bold leading-[1.1] relative shrink-0 text-[64px] tracking-[-0.0128px] w-[494px]" style={{ fontVariationSettings: "'opsz' 14" }}>
        Sobre nosotros
      </p>
      <p className="font-['Lato:Regular',sans-serif] leading-[1.3] not-italic relative shrink-0 text-[24px] w-[466px]">Con más de 30 años de trayectoria en el sector automotriz, nos hemos consolidado como un referente en la distribución de repuestos y soluciones para vehículos. Hoy ampliamos nuestra propuesta con una tienda en línea que incorpora nuevas categorías</p>
    </div>
  );
}
...
function Frame23() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[24px] items-start left-[108px] text-white top-[2456px] w-[528px]">
      <p className="font-['DM_Sans:Bold',sans-serif] font-bold leading-[1.1] relative shrink-0 text-[64px] tracking-[-0.0128px] w-[494px]" style={{ fontVariationSettings: "'opsz' 14" }}>
        Calidad
      </p>
      <p className="font-['Lato:Regular',sans-serif] leading-[1.3] not-italic relative shrink-0 text-[24px] w-[466px]">Con más de 30 años de trayectoria en el sector automotriz, nos hemos consolidado como un referente en la distribución</p>
    </div>
  );
}
...
function Frame6() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[24px] items-start left-[calc(58.33%+8px)] text-[#262352] top-[894px] w-[528px]">
      <p className="font-['DM_Sans:Bold',sans-serif] font-bold leading-[1.1] relative shrink-0 text-[64px] tracking-[-0.0128px] w-[494px]" style={{ fontVariationSettings: "'opsz' 14" }}>
        Ferretería y herramientas
      </p>
      <p className="font-['Lato:Regular',sans-serif] leading-[1.3] not-italic relative shrink-0 text-[24px] w-[466px]">Ahora con ferretería, herramientas y productos para el hogar, ofreciendo a nuestros clientes más opciones en un solo lugar. Seguimos trabajando con el mismo compromiso de siempre: calidad, confianza y buen servicio.</p>
    </div>
  );
}
...
function Frame8() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[24px] items-start left-[calc(58.33%+8px)] text-[#262352] top-[1960px] w-[528px]">
      <p className="font-['DM_Sans:Bold',sans-serif] font-bold leading-[1.1] relative shrink-0 text-[64px] tracking-[-0.0128px] w-[494px]" style={{ fontVariationSettings: "'opsz' 14" }}>
...
function Frame7() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[24px] items-start left-[108px] text-[#262352] top-[1402px] w-[528px]">
      <p className="font-['DM_Sans:Bold',sans-serif] font-bold leading-[1.1] relative shrink-0 text-[64px] tracking-[-0.0128px] w-[494px]" style={{ fontVariationSettings: "'opsz' 14" }}>
...
function Frame22() {
  return (
    <div className="absolute content-center flex flex-wrap gap-[20px] h-[262px] items-center left-[calc(50%+56px)] pointer-events-none top-[2419px] w-[610px]">
...
export default function SobreNosotros() {
  return (
    <div className="bg-white relative size-full" data-name="Sobre nosotros">
      <div className="absolute bg-[#262352] h-[652px] left-0 top-[128px] w-[1440px]" />
      <div className="absolute bg-[#262352] h-[371px] left-0 top-[2364px] w-[1440px]" />
      <div className="absolute h-[752px] left-0 top-[128px] w-[1440px]" />
      <Group4 />
      <div className="absolute bottom-0 h-[3091px] left-0 pointer-events-none top-[48px]">
      ...
      <Frame7 />
      <Frame22 />
      <div className="absolute h-[516px] left-[calc(50%+48px)] rounded-[24px] top-[193px] w-[620px]" data-name="image 60">
        <div className="absolute inset-0 overflow-hidden pointer-events-none rounded-[24px]">
          <img alt="" className="absolute h-[112.22%] left-0 max-w-none top-0 w-full" src={imgImage61} />
        </div>
      </div>
      <div className="absolute h-[528px] left-0 top-[780px] w-[720px]" data-name="image 61">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <img alt="" className="absolute h-[204.65%] left-0 max-w-none top-[-71.98%] w-full" src={imgImage63} />
        </div>
      </div>
      <div className="absolute h-[528px] left-0 top-[1836px] w-[720px]" data-name="image 63">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <img alt="" className="absolute h-[295.08%] left-0 max-w-none top-[-147.45%] w-full" src={imgImage64} />
        </div>
      </div>
      <div className="absolute h-[528px] left-1/2 top-[1308px] w-[720px]" data-name="image 62">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <img alt="" className="absolute h-[204.65%] left-0 max-w-none top-[-71.98%] w-full" src={imgImage65} />
        </div>
      </div>
    </div>
  );
