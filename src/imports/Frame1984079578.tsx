import svgPaths from "./svg-2oa6w8deuz";
...
import { imgArrowForward } from "./svg-vtpcj";
...
function Frame8() {
  return (
    <div className="content-stretch flex items-center justify-between relative shrink-0 w-full">
      ...
      <div className="bg-white content-stretch flex gap-[4px] h-[54px] items-center justify-center p-[16px] relative rounded-[12px] shrink-0 w-[74px]" data-name="Botones">
        ...
        <div className="relative shrink-0 size-[24px]" data-name="arrow_forward">
          <div className="absolute inset-[18.75%] mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[-4.5px_-4.5px] mask-size-[24px_24px]" data-name="arrow_forward" style={{ maskImage: `url('${imgArrowForward}')` }}>
...
function Frame1() {
  return (
    <div className="bg-[#f0f0f2] content-stretch flex flex-col gap-[10px] items-center p-[24px] relative rounded-[12px] shrink-0 w-[304px]">
      ...
      <p className="font-['Lato:Bold',sans-serif] h-[31px] leading-[1.3] not-italic relative shrink-0 text-[#262352] text-[24px] w-[264px]">Autopartes</p>
