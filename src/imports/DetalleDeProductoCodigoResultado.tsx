import svgPaths from "./svg-hou197a5ze";
...
import { imgVerified, imgKidStar } from "./svg-4bgaa";
...
function Frame6() {
  return (
    <div className="content-stretch flex gap-[4px] items-center relative shrink-0">
      ...
      <p className="font-['Lato:Bold',sans-serif] leading-[1.3] not-italic relative shrink-0 text-[#6b6b7b] text-[24px] w-[210px]">Buscar por vehículo</p>
    </div>
  );
}
      ...
      <div className="relative shrink-0 size-[24px]" data-name="docs">
        <div className="absolute inset-[10.42%_18.75%] mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[-4.5px_-2.5px] mask-size-[24px_24px]" data-name="docs" style={{ maskImage: `url('${imgVerified}')` }}>
          <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 15 19">
            <path d={svgPaths.p1596ba10} fill="var(--fill-0, #302C67)" id="docs" />
          </svg>
        </div>
      </div>
      <p className="font-['Lato:Bold',sans-serif] leading-[1.3] not-italic relative shrink-0 text-[#302c67] text-[24px] whitespace-nowrap">Buscar por código</p>
    </div>
  );
}
    ...
    <div className="bg-white h-[52px] relative rounded-[12px] shrink-0 w-full" data-name="Campo">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[12px] items-center px-[12px] py-[4px] relative size-full">
          ...
          <p className="flex-[1_0_0] font-['Lato:Regular',sans-serif] leading-[1.5] min-h-px min-w-px not-italic relative text-[#302c67] text-[14px] tracking-[0.0014px]">4S4BP62C187306539</p>
          <div className="relative shrink-0 size-[24px]" data-name="close">
            <div className="-translate-y-1/2 absolute aspect-[13.307501792907715/13.307501792907715] left-[22.28%] mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[-5.347px_-5.346px] mask-size-[24px_24px] right-[22.27%] top-1/2" data-name="close" style={{ maskImage: `url('${imgVerified}')` }}>
...
function Frame98() {
  return (
    <div className="content-stretch flex items-end justify-between relative shrink-0 w-full">
      <div className="content-stretch flex flex-col gap-[4px] h-[80px] items-start relative shrink-0 w-[743px]" data-name="Campos">
        <p className="font-['Lato:Regular',sans-serif] h-[24px] leading-[1.5] not-italic relative shrink-0 text-[#6b6b7b] text-[14px] tracking-[0.0014px] w-full">Buscar por código</p>
        <Campo2 />
      </div>
      <div className="bg-[#302c67] content-stretch flex gap-[4px] h-[54px] items-center justify-center p-[16px] relative rounded-[12px] shrink-0 w-[400px]" data-name="Botones">
        <p className="font-['Lato:Regular',sans-serif] leading-[1.5] not-italic relative shrink-0 text-[16px] text-white whitespace-nowrap">{`Buscar `}</p>
        <div className="relative shrink-0 size-[24px]" data-name="search">
          <div className="absolute inset-[14.1%_14.18%_14.26%_14.18%] mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[-3.404px_-3.385px] mask-size-[24px_24px]" data-name="search" style={{ maskImage: `url('${imgVerified}')` }}>
            <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 17.192 17.1923">
...
function Frame8() {
  return (
    <div className="absolute bg-white content-stretch flex flex-col gap-[24px] items-start left-[64px] px-[64px] py-[48px] rounded-[24px] top-[407px] w-[1312px]">
      <div aria-hidden="true" className="absolute border-[#302c67] border-[0.5px] border-solid inset-0 pointer-events-none rounded-[24px]" />
      <Frame9 />
      <div className="h-0 relative shrink-0 w-full">
        <div className="absolute inset-[-1px_0_0_0]">
      ...
      <div className="absolute h-0 left-[354px] top-[103px] w-[215px]">
        <div className="absolute inset-[-2px_0_0_0]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 215 2">
            <line id="Line 31" stroke="var(--stroke-0, #302C67)" strokeWidth="2" x2="215" y1="1" y2="1" />
          </svg>
        </div>
      </div>
      <Frame98 />
      <p className="font-['Lato:Bold',sans-serif] leading-[1.3] min-w-full not-italic relative shrink-0 text-[#302c67] text-[24px] w-[min-content]">2008 TOYOTA CORROLA 2.5I LIMITED</p>
    </div>
  );
}

export default function DetalleDeProductoCodigoResultado() {
  return (
    <div className="bg-white relative size-full" data-name="Detalle de producto/codigo/resultado">
      <Group1 />
