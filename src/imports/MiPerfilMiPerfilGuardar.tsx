...
function Frame16() {
  return (
    <div className="absolute content-stretch flex gap-[10px] items-center left-0 px-[64px] py-[12px] top-[151px] w-[1440px]">
      ...
      <div className="flex flex-col font-['Lato:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#302c67] text-[14px] tracking-[0.0014px] whitespace-nowrap">
        <p className="leading-[1.5]">Mi perfil</p>
      </div>
    </div>
  );
}
    ...
    <div className="bg-[#fafafa] h-[52px] relative rounded-[12px] shrink-0 w-full" data-name="Campo">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center px-[12px] py-[4px] relative size-full">
          <p className="flex-[1_0_0] font-['Lato:Regular',sans-serif] leading-[1.5] min-h-px min-w-px not-italic relative text-[#6b6b7b] text-[14px] tracking-[0.0014px]">Ingresa nombre y apellido</p>
        </div>
      </div>
    </div>
  );
...
function Frame26() {
  return (
    <div className="content-stretch flex gap-[48px] items-start relative shrink-0 w-full">
      <div className="content-stretch flex flex-col gap-[4px] items-start relative shrink-0 w-[384px]" data-name="Campos">
        <p className="font-['Lato:Regular',sans-serif] h-[24px] leading-[1.5] not-italic relative shrink-0 text-[#302c67] text-[14px] tracking-[0.0014px] w-full">Nombre completo *</p>
        <Campo />
      </div>
      <div className="content-stretch flex flex-col gap-[4px] h-[80px] items-start relative shrink-0 w-[384px]" data-name="Campos">
...
function Campo2() {
  return (
    <div className="bg-[#fafafa] h-[52px] relative rounded-[12px] shrink-0 w-full" data-name="Campo">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center px-[12px] py-[4px] relative size-full">
          <p className="flex-[1_0_0] font-['Lato:Regular',sans-serif] leading-[1.5] min-h-px min-w-px not-italic relative text-[#6b6b7b] text-[14px] tracking-[0.0014px]">Ingresa tu número</p>
        </div>
      </div>
    </div>
  );
...
function Campo3() {
  return (
    <div className="bg-[#fafafa] h-[52px] relative rounded-[12px] shrink-0 w-full" data-name="Campo">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center px-[12px] py-[4px] relative size-full">
          <p className="flex-[1_0_0] font-['Lato:Regular',sans-serif] leading-[1.5] min-h-px min-w-px not-italic relative text-[#6b6b7b] text-[14px] tracking-[0.0014px]">Ingresar número de cédula de identidad</p>
        </div>
      </div>
    </div>
  );
...
function Frame27() {
  return (
    <div className="content-stretch flex gap-[48px] items-start relative shrink-0 w-full">
      <div className="content-stretch flex flex-col gap-[4px] items-start relative shrink-0 w-[384px]" data-name="Campos">
        <p className="font-['Lato:Regular',sans-serif] h-[24px] leading-[0] not-italic relative shrink-0 text-[#302c67] text-[14px] tracking-[0.0014px] w-full">
          <span className="leading-[1.5]">{`Número de teléfono `}</span>
      ...
      <div className="content-stretch flex flex-col gap-[4px] items-start relative shrink-0 w-[384px]" data-name="Campos">
        <p className="font-['Lato:Regular',sans-serif] h-[24px] leading-[0] not-italic relative shrink-0 text-[#302c67] text-[14px] tracking-[0.0014px] w-full">
          <span className="leading-[1.5]">{`Cédula de identidad (C.I.) `}</span>
          <span className="leading-[1.5]">*</span>
        </p>
        <Campo3 />
      </div>
...
function Campo4() {
  return (
    <div className="bg-[#fafafa] h-[52px] relative rounded-[12px] shrink-0 w-full" data-name="Campo">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center px-[12px] py-[4px] relative size-full">
          <p className="flex-[1_0_0] font-['Lato:Regular',sans-serif] leading-[1.5] min-h-px min-w-px not-italic relative text-[#6b6b7b] text-[14px] tracking-[0.0014px]">Ingresar nombre o razón social</p>
        </div>
      </div>
    </div>
  );
...
function Campo5() {
  return (
    <div className="bg-[#fafafa] h-[52px] relative rounded-[12px] shrink-0 w-full" data-name="Campo">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center px-[12px] py-[4px] relative size-full">
          <p className="flex-[1_0_0] font-['Lato:Regular',sans-serif] leading-[1.5] min-h-px min-w-px not-italic relative text-[#6b6b7b] text-[14px] tracking-[0.0014px]">{`Ingresa tu número de C.I. o N.I.T. `}</p>
        </div>
      </div>
    </div>
  );
...
function Frame28() {
  return (
    <div className="content-stretch flex gap-[48px] items-start relative shrink-0 w-full">
      <div className="content-stretch flex flex-col gap-[4px] items-start relative shrink-0 w-[384px]" data-name="Campos">
        <p className="font-['Lato:Regular',sans-serif] h-[24px] leading-[1.5] not-italic relative shrink-0 text-[#302c67] text-[14px] tracking-[0.0014px] w-full">Nombre o razón social</p>
        <Campo4 />
      </div>
      <div className="content-stretch flex flex-col gap-[4px] h-[80px] items-start relative shrink-0 w-[384px]" data-name="Campos">
        <p className="font-['Lato:Regular',sans-serif] h-[24px] leading-[1.5] not-italic relative shrink-0 text-[#302c67] text-[14px] tracking-[0.0014px] w-full">Número de C.I. o N.I.T.</p>
        <Campo5 />
      </div>
    </div>
  );
...
function Frame25() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[24px] items-end left-[calc(33.33%+32px)] p-[24px] rounded-[12px] top-[352px] w-[864px]">
      <div aria-hidden="true" className="absolute border border-[#bfbed0] border-solid inset-0 pointer-events-none rounded-[12px]" />
      <div className="flex flex-col font-['Lato:Bold',sans-serif] h-[58px] justify-center leading-[0] not-italic relative shrink-0 text-[#302c67] text-[24px] w-full">
        <p className="leading-[1.3]">Mi perfil</p>
      </div>
      <Frame26 />
      <Frame27 />
      <div className="flex flex-col font-['Lato:Bold',sans-serif] h-[58px] justify-center leading-[0] not-italic relative shrink-0 text-[#302c67] text-[24px] w-full">
        <p className="leading-[1.3]">Datos de facturación</p>
      </div>
      <Frame28 />
    </div>
  );
...
function Frame17() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col items-start justify-center min-h-px min-w-px relative">
      <p className="font-['Lato:Regular',sans-serif] leading-[1.5] not-italic relative shrink-0 text-[#302c67] text-[18px] w-full">Mi perfil</p>
    </div>
  );
}
...
function Frame19() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col items-start justify-center min-h-px min-w-px relative">
      <p className="font-['Lato:Regular',sans-serif] leading-[1.5] not-italic relative shrink-0 text-[#6b6b7b] text-[18px] w-full">Mis pedidos</p>
    </div>
  );
}
      ...
      <div className="relative shrink-0 size-[24px]" data-name="package_2">
        <div className="absolute inset-[9.49%_14.58%] mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[-3.5px_-2.277px] mask-size-[24px_24px]" data-name="package_2" style={{ maskImage: `url('${imgVerified}')` }}>
          <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 17 19.446">
            <path d={svgPaths.p3290d0f0} fill="var(--fill-0, #6B6B7B)" id="package_2" />
          </svg>
        </div>
      </div>
      <Frame19 />
...
function Frame39() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[8px] items-start left-[64px] top-[352px] w-[416px]">
      <Frame29 />
      <Frame30 />
      <Frame31 />
      <Frame32 />
...
export default function MiPerfilMiPerfilGuardar() {
  return (
    <div className="bg-white relative size-full" data-name="Mi perfil/Mi perfil/guardar">
      <Group4 />
      <Frame16 />
      <p className="absolute font-['DM_Sans:Bold',sans-serif] font-bold leading-[1.15] left-[68px] text-[#6b6b7b] text-[56px] top-[231px] tracking-[-0.0084px] w-[640px]" style={{ fontVariationSettings: "'opsz' 14" }}>
        Mi perfil
      </p>
      <div className="-translate-x-1/2 absolute h-0 left-1/2 top-[313px] w-[1312px]">
        <div className="absolute inset-[-1px_0_0_0]">
      ...
      <Frame25 />
      <Frame39 />
      <div className="absolute bg-[#302c67] content-stretch flex gap-[4px] h-[52px] items-center justify-center left-[calc(33.33%+32px)] p-[16px] rounded-[12px] top-[870px] w-[193px]" data-name="Botones">
        <p className="font-['Lato:Regular',sans-serif] leading-[1.5] not-italic relative shrink-0 text-[16px] text-white whitespace-nowrap">Guardar</p>
      </div>
